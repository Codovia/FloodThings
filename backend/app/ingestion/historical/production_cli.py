...
def run_cli(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"  Grid Cells:                {audit.total_cells}")
    ...
    print(f"    - Estimated 858 Raw Compressed: {audit.estimated_total_raw_compressed_bytes / (1024*1024):.2f} MB")
    ...
    print(f"    - Estimated 858 Raw Uncomp.: {audit.estimated_total_raw_uncompressed_bytes / (1024*1024*1024):.3f} GB")
