...
| **KGIS / KSRSAC** | KSRSAC | Gazetted Administrative Boundaries | District, Taluk boundaries (31 districts, 240 taluks) | `https://kgis.karnataka.gov.in` | Verified Shapefiles (`data/raw/gis/ksrsac/District.shp`, `Taluk.shp`) | Yes | No (Open spatial data) | Read / Normalize | Local Shapefile | Shapefile | Karnataka statewide | Survey scale (1:50k) | Static | Current gazetted (2026) | Periodic | Polygons / MultiPolygons | N/A | Source: EPSG:32643, Target: EPSG:4326 | 31 District and 240 Taluk polygons | Govt of Karnataka (KSRSAC) | Verified Offline Archive | `VERIFIED` | 2026-09-18 | Validated offline shapefiles; normalized in memory via `KsrsacAdminNormalizer` (EPSG:32643 → EPSG:4326). 3 taluks deterministically repaired via `make_valid()` with zero raw-file alterations. |
