...
| **KGIS / KSRSAC** | KSRSAC | Administrative Boundaries | State, District, Taluk boundaries (1 state, 31 districts, 240 taluks) | `https://kgis.ksrsac.in/kgis/downloads.aspx` | Verified Shapefiles (`data/raw/gis/ksrsac/State.shp`, `District.shp`, `Taluk.shp`) | Yes | No (Open spatial data) | Read / Normalize | Local Shapefile | Shapefile | Karnataka statewide | Survey scale (1:50k) | Static | Current release (2026) | Periodic | Polygons / MultiPolygons | N/A | Source: EPSG:32643, Target: EPSG:4326 | 1 State (`KGISStateC=29`, `KGISStateN=Karnataka`), 31 District, 240 Taluk polygons | Govt of Karnataka (KSRSAC) | Verified Offline Archive | `VERIFIED` | 2026-09-18 | Validated offline shapefiles (`State.shp`, `District.shp`, `Taluk.shp`). Normalized in memory via `KsrsacAdminNormalizer` (EPSG:32643 → EPSG:4326). State is exactly 1 valid MultiPolygon feature. Raw source files remain strictly unmodified. |
